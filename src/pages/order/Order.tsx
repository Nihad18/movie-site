...
const Order = () => {
    ...
    return (
        <div className='flex h-[100vh] w-[100vw] bg-black'>
            <div className='container absolute left-0 right-0 z-10 w-full xl:top-[70px] 2xl:top-[100px]'>
                    ...
                    <div className={styles["modal-inner"]}>
                        <div className="relative h-full">
                            ...
                            <div className="py-[54px] h-full px-[74px] text-center">
                                <h5 className="font-semibold text-[20px] leading-[64px] mb-[14px]">Congratulations!</h5>
