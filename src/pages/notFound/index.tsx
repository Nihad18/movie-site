    ...
    return (
        ...
        C86.34,11.918,137.664-5.445,189.928,1.502l-3.95,29.738C143.041,25.54,100.895,39.789,70.343,70.343z"
                            ...
                            <div className={styles["display_div"]}>
                                <div className={styles["screen_out"]}>
                                    <div className={styles["screen_out1"]}>
                                        <div className={`${styles["screen"]} ${Math.random() < 0.5 ? "" : styles['aditional-style']}`}>
                        ...
                        <div className={styles["bottom"]}>
                            ...
                            <div className={`${styles["base3"]} dark:bg-[#fff!important]`}></div>
                        </div>
                    </div>
                    <div className={`${styles["text_404"]} dark:text-white`}>
                        <div className={`${styles["text_4041"]} dark:text-white`}>4</div>
                        <div className={`${styles["text_4042"]} dark:text-white`}>0</div>
                        <div className={`${styles["text_4043"]} dark:text-white`}>4</div>
                    </div>
                </div>
