    ...
    <div className={styles.login}>
      <div className={`${styles.wrapper}`}>
        ...
        <div className="mt-3 text-center">
          ...
          <Link className="text-blue-600 font-semibold" data-testid="login-link" data-track-action="click_login_from_sign_in_page" data-track-label="free_registration" to="/login">Login</Link>
        </div>
      </div>
    </div>
  )
